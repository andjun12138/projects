//  列表查询路径 /admin/searchRecord/query  post
var $table = $('#table'),
...
function queryParams(params) {
    ...
    if(!!searchOptions.keyWords)postData['keyWords'] = searchOptions.keyWords;
    return postData;
}
//搜索
...
function initSearchOptions() {
    searchOptions['keyWords'] = $("#keyWords").val();
}
