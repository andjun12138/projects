...
function responseHandler(res) {
    ...
    for(var i = 0;i < length;i++) {
        data[i].name = '<a target="_blank" href="/cnkiApply/to_create_update/'+data[i].id+'.html">'+data[i].name+'</a>';
        //    审核状态
...
function queryParams(params) {
    ...
    if(!!searchOptions.company)postData['company'] = searchOptions.company;
    return postData;
}
...
function initSearchOptions() {
    ...
    searchOptions['company'] = $("#company").val();
