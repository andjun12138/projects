...
var $save = $('#save'),
    ...
    $reset = $('#reset'),
    $form = $("#newForm");
var clearanceLinkManageId = $('#selectItemId').val()
// 内存数据管理
var FORM_PREVIEW = {
    state: {
        deleteFileIds: []
...
function initPage() {
    ...
    $save.on('click', function (e) {
        ...
        if (!!clearanceLinkManageId) {
            postData['id'] = clearanceLinkManageId;
            $.ajax({
                url: '/clearanceLinkManage/create_update',
