// 保存或修改接口 /starEnterpriseId/create_update  POST
/*
...
var $save = $('#save'),
    ...
    $form = $("#newForm");
var fileLength=0;
var starEnterpriseId = $('#starEnterpriseId').val()
// 内存数据管理
var FORM_PREVIEW = {
    state: {
        deleteFileIds: []
...
function initPage() {
    ...
    $save.on('click', function (e) {
        ...
        if (!!starEnterpriseId) {
            postData['id'] = starEnterpriseId;
            $.ajax({
                url: '/starEnterprise/create_update',
