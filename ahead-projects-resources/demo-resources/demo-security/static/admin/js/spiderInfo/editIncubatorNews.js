var spiderIncubatorNewsId = $("#spiderIncubatorNewsId").val();
// 消息框位置控制
...
$(function(){
    ...
    // 如果存在父窗口，获取窗口索引
    if(typeof parent.layer !== 'undefined' && spiderIncubatorNewsId !== null) {
    ...
    $save.click(function () {
        ...
        // 如果存在id
        if(typeof spiderIncubatorNewsId !== 'undefined' && spiderIncubatorNewsId !== null && spiderIncubatorNewsId !== '' ){
            postData['id'] = spiderIncubatorNewsId;
            postData['published'] = true;
            console.log(postData);
            $.ajax({
                url: '/spiderInfo/incubatorNews/update',
