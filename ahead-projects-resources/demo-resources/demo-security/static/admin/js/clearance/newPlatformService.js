// 保存或修改接口 /platformService/create_update  POST
/*
...
var $save = $('#save'),
    ...
    $form = $("#newForm");
var fileLength=0;
var platformServiceId = $('#selectItemId').val()
// 内存数据管理
var FORM_PREVIEW = {
    state: {
        deleteFileIds: []
...
function initPage() {
    ...
    $save.on('click', function (e) {
        ...
        if (!!platformServiceId) {
            postData['id'] = platformServiceId;
            $.ajax({
                url: '/platformService/create_update',
