 ...
 * 新建表单
 */
var enumSelectItemId = $("#enumSelectItemId").val();
var pid = $("#pid").val();
// 消息框位置控制
...
$(function(){
    ...
    // 如果存在父窗口，获取窗口索引
    if(typeof parent.layer !== 'undefined' && enumSelectItemId !== null) {
    ...
    $save.click(function () {
        ...
        // 如果存在id
        if(typeof enumSelectItemId !== 'undefined' && enumSelectItemId !== null && enumSelectItemId !== '' ){
            postData['id'] = enumSelectItemId;
            $.ajax({
                url: '/admin/enumSelectItem/create_update',
