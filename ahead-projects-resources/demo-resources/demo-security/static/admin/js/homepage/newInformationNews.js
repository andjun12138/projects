var informationNewsId = $("#informationNewsId").val();
// 消息框位置控制
...
$(function(){
    ...
    // 如果存在父窗口，获取窗口索引
    if(typeof parent.layer !== 'undefined' && informationNewsId !== null) {
        var index = parent.layer.getFrameIndex(window.name);
    }
    if (informationNewsId !== ""){
        initPage();
    }
    ...
    $save.click(function () {
        ...
        console.log(informationNewsId)

        // 如果存在id
        if(typeof informationNewsId !== 'undefined' && informationNewsId !== null && informationNewsId !== '' ){
            // if (!!industryInformationThirdPageSeo) {
            //     postData1['id'] = industryInformationThirdPageSeo.id;
            // }
            //
            // postData1['informationId'] = informationNewsId;
            ...
            postData['id'] = informationNewsId;
            console.log(postData);
            $.ajax({
                url: '/informationNews/create_update',
