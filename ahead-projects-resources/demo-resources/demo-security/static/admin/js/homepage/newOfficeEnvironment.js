// 保存或修改接口 /officeEnvironment/create_update  POST
/*
...
var $save = $('#save'),
    ...
    $form = $("#newForm");
var fileLength=0;
var officeEnvironmentId = $('#selectItemId').val()
// 内存数据管理
var FORM_PREVIEW = {
    state: {
        deleteFileIds: []
...
function initPage() {
    ...
    $save.on('click', function (e) {
        ...
        if (!!officeEnvironmentId) {
            postData['id'] = officeEnvironmentId;
            $.ajax({
                url: '/officeEnvironment/create_update',
