var incubatorArticleId = $("#incubatorArticleId").val();
// 消息框位置控制
...
$(function(){
    ...
    // 如果存在父窗口，获取窗口索引
    if(typeof parent.layer !== 'undefined' && incubatorArticleId !== null) {
    ...
    $save.click(function () {
        ...
        console.log(incubatorArticleId)

        // 如果存在id
        if(typeof incubatorArticleId !== 'undefined' && incubatorArticleId !== null && incubatorArticleId !== '' ){
            // if (!!industryInformationThirdPageSeo) {
            //     postData1['id'] = industryInformationThirdPageSeo.id;
            // }
            //
            // postData1['informationId'] = incubatorArticleId;
            ...
            postData['id'] = incubatorArticleId;
