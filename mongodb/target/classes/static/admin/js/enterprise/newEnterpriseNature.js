/**
 * 跳转到新建或者编辑页面  /style/{selectItemId}/to_create_update
 * 请求方式：get
 * 请求参数：selectItemId
 */

/**
 * 保存或修改接口  /admin/result/style/create_update
 * 请求方式：post
 */
...
//    重置
    ...
    $save.click(function() {
        ...
        var id = $('#selectItemId').val();
        if(!!id){
            postData['id'] = id;
            $.ajax({
                url:'/admin/enterprise/nature/create_update',
