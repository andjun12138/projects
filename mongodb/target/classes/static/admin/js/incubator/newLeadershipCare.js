var leadershipCareId = $("#leadershipCareId").val();
// 消息框位置控制
...
$(function(){
    ...
    // 如果存在父窗口，获取窗口索引
    if(typeof parent.layer !== 'undefined' && leadershipCareId !== null) {
    ...
    $save.click(function () {
        ...
        if (!!$('.file-name').data('id')) {
            postData['pictures'] = $('.file-name').data('id');
        } else {
        ...
        // console.log(leadershipCareId)

        // 如果存在id
        if(typeof leadershipCareId !== 'undefined' && leadershipCareId !== null && leadershipCareId !== '' ){
            postData['id'] = leadershipCareId;
            postData['published'] = true;
            console.log(postData);
            $.ajax({
                url: '/leadershipCare/create_update',
